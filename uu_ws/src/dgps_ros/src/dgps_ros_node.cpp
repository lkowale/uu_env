...
int main(int argc, char **argv)
{
    ...
    args.nmea = "$GPGGA,091903.011,5331.222,N,01749.545,E,1,12,1.0,0.0,M,0.0,M,,*65";
    ...
    ROS_INFO("serverName= %s",args.server); 
    ROS_INFO("serverPort= %s",args.port); 
    ROS_INFO("serdevice= %s",args.serdevice); 
