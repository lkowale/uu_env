...
def bno08x_node():
    ...
    rate = rospy.Rate(50) # frequency in Hz
    ...
    while not rospy.is_shutdown():
        ...
        raw_msg.orientation_covariance[0] = 0.0005
        raw_msg.linear_acceleration_covariance[0] = 0.5
        raw_msg.angular_velocity_covariance[0] = 0.5

        raw_msg.orientation_covariance[4] = 0.0005
        raw_msg.linear_acceleration_covariance[4] = 0.5
        raw_msg.angular_velocity_covariance[4] = 0.5

        raw_msg.orientation_covariance[8] = 0.0005
        raw_msg.linear_acceleration_covariance[8] = 0.5
        raw_msg.angular_velocity_covariance[8] = 0.5
